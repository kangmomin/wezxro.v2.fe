                ...
                <div class="modal_body" style="height: 850px;">
                    ...
                    <form action="./add-deposit" class="form" method="POST">
                        ...
                        <div class="form-group">
                            {#if !isDemo }
                                <p style="color: black; margin-bottom: 10px; font-size: 16px;">부산은행 112-2007-03-7109
                                    정화랑</p>
                            {:else}
                        ...
                        <div class="form-group" style="margin-top: 18px;">
                            <span class="control-label" style="color: black; margin-bottom: 10px; font-size: 16px; margin-right: 10px;">
                                <input checked id="none" name="type" type="radio" value="선택안함"> 선택안함
                            </span>
                            <span class="control-label" style="color: black; margin-bottom: 10px; font-size: 16px; margin-right: 10px;">
                                <input id="business" name="type" type="radio" value="세금계산서"> 세금계산서
                            </span>
                            <span class="control-label" style="color: black; margin-bottom: 10px; font-size: 16px; margin-right: 10px;">
                        ...
                        <div class="form-group businessform" style="margin-top: 4px;">
                            <div class="row">
                                ...
                                <div class="col-md-6" style="margin-bottom: 8px;">
                                    ...
                                    <input class="form-control" id="business_regno" name="business_regno" type="text">
                                </div>
                                <div class="col-md-6" style="margin-bottom: 8px;">
                                    <label class="control-label" for="username"
                                ...
                                <div class="col-md-6" style="margin-bottom: 8px;">
                                    ...
                                    <input class="form-control" id="business_phone" name="business_phone" type="text">
                                </div>
                                <div class="col-md-12">
                                    <label class="control-label" for="username"
                                           style="color: black; margin-bottom: 10px; font-size: 16px;">이메일</label>
                                    <input class="form-control" id="business_email" name="business_email" type="text">
                                </div>
                            </div>
                        </div>
                ...
                <span class="custom-control-label text-uppercase"
                      style="font-size: 16px; margin-bottom: 8px; font-weight: 400; line-height: 1.5"><input
                        ...
                        <div class="form-actions left text-center">
                            ...
                            {/if}
                            <a href="./transactions"
                               style="font-size: 14px; color: grey; font-weight: 700; text-align: center;">돌아가기</a>
                        </div>
                    </form>
                </div>
            </div>
                    ...
                    <div class="col-md-6">
                        <div class="row card justify-content-between"
                            ...
                            <div class="col-md-12">
                                ...
                                <button type="submit" on:click={togglePayForm}>aipwjd</button>

                                <input type="button" class="nav-link btn btn-info mb-1" on:click={togglePayForm} style="margin-top: 22px; width: 100%; font-size: 24px;" value="무통장 입금" />
                                <div class="row">
