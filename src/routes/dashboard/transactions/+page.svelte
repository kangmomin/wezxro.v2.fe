                    ...
                    <form action="" class="form" method="POST">
                        ...
                        <div class="form-group" style="margin-top: 18px;">
                            <span class="control-label"
                                ...
                                <input checked id="none" name="type" type="radio" value="선택안함" on:click={() => formType = "none"}> 선택안함
                            </span>
                            <span class="control-label"
                                  style="color: black; margin-bottom: 10px; font-size: 16px; margin-right: 10px;">
                                <input id="business" name="type" type="radio" value="세금계산서" on:click={() => formType = "businessform"}> 세금계산서
                            </span>
                            <span class="control-label"
                                  style="color: black; margin-bottom: 10px; font-size: 16px; margin-right: 10px;">
                                <input id="personal" name="type" type="radio" value="현금영수증" on:click={() => formType = "personalform"}/>
                                현금영수증
                            </span>
                        </div>
                ...
                <span class="custom-control-label text-uppercase"
                      style="font-size: 16px; margin-bottom: 8px; font-weight: 400; line-height: 1.5"><input
                        ...
                        <div class="form-actions left text-center">
                            ...
                            {/if}
                            <a href="./transactions"
                               style="font-size: 14px; color: grey; font-weight: 700; text-align: center;" on:click={() => payform.set(false)}>돌아가기</a>
                        </div>
                    </form>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    <div class="row card justify-content-between"
                        ...
                        <div class="col-md-12">
                            ...
                            <input class="nav-link btn btn-info mb-1" on:click={togglePayForm} style="margin-top: 22px; width: 100%; font-size: 24px;"
