            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="tp-faq-wrapper mb-80">
                        ...
                        {#if config.faq.shape.isUse === undefined || config.faq.shape.isUse }
                        <div class="tp-faq-img p-relative">
                            <button on:click={() => location.href = config.faq.shape.linkTo}>
                                <span style="{config.faq.shape.url !== "" ? "background: none" : ""}">
                                    {#if config.faq.shape.url !== ""}
                                        <img src="{config.faq.shape.url}" alt="" width="80px" height="80px">
                                    {:else}
