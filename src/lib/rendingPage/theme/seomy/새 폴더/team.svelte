...
<body>
   ...
   <main>
            ...
            <div class="row">
               <div class="col-xxl-12">
                  <div class="breadcrumb__content breadcrumb__content-2 text-center p-relative z-index-1">
                     <h3 class="breadcrumb__title">Team Member</h3>
      ...
      <!-- team-area-start -->
      <section class="team-area pt-100 pb-40">
         <div class="container">
            <div class="row gx-9">
               <div class="col-lg-3 col-md-6">
                  <div class="team-5-item text-center mb-80">
                     ...
                     <div class="team-5-content">
                        <h4 class="team-5-title">
                           <a href="team-details.html">Danny Russell</a>
                        </h4>
                        <p>Founder & CEO</p>
                     </div>
                  </div>
               ...
               <div class="col-lg-3 col-md-6">
                  <div class="team-5-item team-5-item-2 text-center mb-80">
                     <div class="team-5-thumb mb-25">
                     ...
                     <div class="team-5-content">
                        <h4 class="team-5-title">
                           <a href="team-details.html">Byron Conner</a>
                        </h4>
                        <p>SEO Expart</p>
                     </div>
                  </div>
               ...
               <div class="col-lg-3 col-md-6">
                  <div class="team-5-item team-5-item-3 text-center mb-80">
                     <div class="team-5-thumb mb-25">
               ...
               <div class="col-lg-3 col-md-6">
                  <div class="team-5-item team-5-item-4 text-center mb-80">
                     <div class="team-5-thumb mb-25">
               ...
               <div class="col-lg-3 col-md-6">
                  <div class="team-5-item team-5-item-5 text-center mb-80">
                     <div class="team-5-thumb mb-25">
                        <img src="assets/img/team/team-5-5.png" alt="">
                        <div class="team-5-social">
                           <span class="icon"></span>
                           <a href="#"><i class="fa-brands fa-facebook-f"></i></a>
                           <a href="#"><i class="fa-brands fa-twitter"></i></a>
               ...
               <div class="col-lg-3 col-md-6">
                  <div class="team-5-item team-5-item-6 text-center mb-80">
                     <div class="team-5-thumb mb-25">
                        <img src="assets/img/team/team-5-6.png" alt="">
                        <div class="team-5-social">
                           <span class="icon"></span>
                           <a href="#"><i class="fa-brands fa-facebook-f"></i></a>
                           <a href="#"><i class="fa-brands fa-twitter"></i></a>
                     ...
                     <div class="team-5-content">
                        ...
                        <p>Consulting Officer</p>
                     </div>
                  </div>
               </div>
               <div class="col-lg-3 col-md-6">
                  <div class="team-5-item team-5-item-7 text-center mb-80">
                     <div class="team-5-thumb mb-25">
                        <img src="assets/img/team/team-5-7.png" alt="">
                        <div class="team-5-social">
                           <span class="icon"></span>
                           <a href="#"><i class="fa-brands fa-facebook-f"></i></a>
                           <a href="#"><i class="fa-brands fa-twitter"></i></a>
                     ...
                     <div class="team-5-content">
                        <h4 class="team-5-title">
                           <a href="team-details.html">Zin Denvar</a>
                        </h4>
                        <p>Sales Manager </p>
                     </div>
                  </div>
               ...
               <div class="col-lg-3 col-md-6">
                  <div class="team-5-item team-5-item-8 text-center mb-80">
                     <div class="team-5-thumb mb-25">
                        <img src="assets/img/team/team-5-8.png" alt="">
                        <div class="team-5-social">
                           <span class="icon"></span>
                           <a href="#"><i class="fa-brands fa-facebook-f"></i></a>
                           <a href="#"><i class="fa-brands fa-twitter"></i></a>
                     ...
                     <div class="team-5-content">
                        <h4 class="team-5-title">
                           <a href="team-details.html">Maurice Craig</a>
                        </h4>
