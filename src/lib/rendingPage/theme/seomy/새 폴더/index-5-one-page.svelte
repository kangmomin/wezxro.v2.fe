...
<body>
                     ...
                     <div class="tpmenu__area tpmenu-5 main-mega-menu">
                        <nav class="tp-main-menu-content">
                           <ul class="tp-onepage-menu">
                              ...
                              <li><a href="#tool-one-page">Tool</a></li>
   ...
   <main>
               ...
               <div class="row">
                  <div class="col-xl-7 col-lg-6 order-2 order-lg-1">
                     <div class="banner-5-content p-relative pt-80">
                        <h4 class="banner-5-title">All in one <br> SEO software made simple.</h4>
            ...
            <div class="row">
               <div class="col-lg-4 col-md-6">
                  <div class="feature-5-item mb-55">
                     <div class="feature-5-icon p-relative mb-40">
                        <img src="assets/img/shape/feature-5-icon-1.png" alt="">
                        <div class="feature-5-icon-shape">
                           <img src="assets/img/shape/feature-5-shape-1.png" alt="">
                        </div>
                        <span></span>
                     </div>
                     <div class="feature-5-content">
                        ...
                        <ul class="feature-5-list">
                           <li><i class="fa-sharp fa-solid fa-circle-check"></i> <span>Audit</span></li>
                           <li><i class="fa-sharp fa-solid fa-circle-check"></i> <span>On page SEO</span></li>
                           <li><i class="fa-sharp fa-solid fa-circle-check"></i> <span>Local SEO</span></li>
                        </ul>
                     </div>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6">
                  <div class="feature-5-item feature-5-item-2 mb-55">
                     <div class="feature-5-icon p-relative mb-40">
                        <img src="assets/img/shape/feature-5-icon-2.png" alt="">
                        <div class="feature-5-icon-shape">
                     ...
                     <div class="feature-5-content">
                        ...
                        <h4 class="feature-5-content-title mb-50">Backlink checking & Monitoring</h4>
                        <ul class="feature-5-list">
                           <li><i class="fa-sharp fa-solid fa-circle-check"></i> <span>Concept</span></li>
                           <li><i class="fa-sharp fa-solid fa-circle-check"></i> <span>layout</span></li>
                           <li><i class="fa-sharp fa-solid fa-circle-check"></i> <span>Programming</span></li>
                        </ul>
                     </div>
                  </div>
               </div>
               <div class="col-lg-4 col-md-6">
                  <div class="traffic-item traffic-bg mb-55">
                     <div class="traffic-item-content">
                        <h4 class="traffic-item-content-title">Website Traffic!</h4>
                        <span>Start the short analysis to find out where the priorities lie.</span>
                     </div>
                     <div class="traffic-item-form">
                        <div class="web-item web-url p-relative">
                           <input type="text" placeholder="https">
                           <i>
                              <img src="assets/img/shape/trafic-icon-1.png" alt="">
                           </i>
                        </div>
                        <div class="web-item web-mail p-relative">
                           <input type="text" placeholder="email">
                           <img src="assets/img/shape/trafic-icon-2.png" alt="">
                        </div>
                     </div>
                     <div class="agreement">
                        <div>
                           <div class="switcher">
                              <label for="toggle-0">
                                 ...
                                 <small>I agree to the <span>Data Protection</span> Agreement.</small>
                              </label>
                           </div>
                        </div>
                     </div>
      ...
      <!-- about-area-start -->
      <section id="about-one-page" class="about-area pb-60 pt-95">
         <div class="container">
            <div class="row">
               <div class="col-lg-7">
                  <div class="about-5">
                        ...
                        <div class="row">
                           <div class="col-lg-6 col-md-6">
                              <div class="about-5-item">
                                 <div class="about-5-item-title mb-20">
                                    <span>
                                       <img src="assets/img/shape/about-5-shape-1.svg" alt="">
                                    </span>
                                 </div>
                                 <div class="about-5-item-text">
                                    <p>
                                       We pride our selves on working <br> as an extension of your marketing <br> team &
                           ...
                           <div class="col-lg-6 col-md-6">
                              <div class="about-5-item about-5-item-2">
                                 <div class="about-5-item-title mb-20">
                                    <span>
                                       <img src="assets/img/shape/about-5-shape-2.svg" alt="">
                                    </span>
                                 </div>
                                 <div class="about-5-item-text">
                                    <p>
                                       We work with the teams that build <br> brands to understand, improve, <br> and
                                       protect.
                                    </p>
                                 </div>
                              </div>
               ...
               <div class="col-lg-5">
                  <div class="about-5-thumb p-relative">
                     <img class="tpchoose-border-anim" src="assets/img/bg/about-5-bg-2.jpg" alt="">
                     <a href="https://www.youtube.com/watch?v=TYYf8zYjP5k" class="popup-video">
                        <div class="about-5-shape">
                           <div class="about-5-shape-one">
                              <img src="assets/img/shape/video-blue.png" alt="">
                           </div>
                           <div class="about-5-shape-two">
                              <img src="assets/img/shape/video-white.png" alt="">
                           </div>
            ...
            <div class="row">
               <div class="col-lg-3 col-sm-6">
                  <div class="counter-5 d-flex mb-30">
                     <div class="counter-5-icon">
                        <i>
                           <img src="assets/img/icon/counter-5-icon-1.svg" alt="">
                        </i>
                     </div>
                        ...
                        <div class="counter-5-bar">
                           <div class="progress">
                              <div class="progress-bar" role="progressbar" aria-label="Example with label"
                                 style="width: 60%;" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100"></div>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="col-lg-3 col-sm-6">
                  <div class="counter-5 counter-5-2 d-flex mb-30">
                     <div class="counter-5-icon">
                        <i>
                           <img src="assets/img/icon/counter-5-icon-2.svg" alt="">
                        </i>
                     </div>
                     <div class="counter-5-content">
                        <b class="counter-5-count mb-10">
                           <span data-purecounter-duration="1" data-purecounter-end="120" class="purecounter"></span>
                           <i class="fa-regular fa-plus"></i>
                        </b>
                        ...
                        <div class="counter-5-bar">
                           <div class="progress">
                              <div class="progress-bar" role="progressbar" aria-label="Example with label"
                                 style="width: 77%;" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div>
                           </div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="col-lg-3 col-sm-6">
                  <div class="counter-5 counter-5-3 d-flex mb-30">
                     <div class="counter-5-icon">
                        <i>
                           <img src="assets/img/icon/counter-5-icon-3.svg" alt="">
                        </i>
                     </div>
                     <div class="counter-5-content">
                        <b class="counter-5-count mb-10">
                           <span data-purecounter-duration="1" data-purecounter-end="160" class="purecounter"></span>
                           <i class="fa-regular fa-plus"></i>
                        </b>
                        <p>Happy Customers</p>
                        <div class="counter-5-bar">
               ...
               <div class="col-lg-3 col-sm-6">
                  <div class="counter-5 counter-5-4 d-flex mb-30">
                     ...
                     <div class="counter-5-content">
                        <b class="counter-5-count mb-10">
                           <span data-purecounter-duration="1" data-purecounter-end="35" class="purecounter"></span>
                           <i class="fa-regular fa-plus"></i>
                        </b>
                        <p>Team Members</p>
                        <div class="counter-5-bar">
      ...
      <!-- toolest-aea-start -->
      <section id="tool-one-page" class="toolest-area toolest-bg pt-105 pb-100">
         <div class="container">
            <div class="row">
               <div class="col-lg-12">
                        ...
                        <div class="tp-accordion-item">
                           <div class="tp-accordion-head">
                              ...
                              <div class="tp-accordion-title pl-30">
                                 <h4 class="tp-toolest-title-info">Find powerful <br> backlinks</h4>
                              </div>
                           </div>
                     ...
                     <div class="nav-link" id="v-pills-messages-tab" data-bs-toggle="pill"
                        ...
                        <div class="tp-accordion-item tp-accordion-item-3">
                           <div class="tp-accordion-head">
                              ...
                              <div class="tp-accordion-title pl-30">
                                 <h4 class="tp-toolest-title-info">Find the<br> Right keywords.</h4>
                              </div>
                           </div>
                           <div class="tp-accordion-content">
                              <p>
                     ...
                     <div class="nav-link" id="v-pills-settings-tab" data-bs-toggle="pill"
                        ...
                        <div class="tp-accordion-item tp-accordion-item-4">
                           <div class="tp-accordion-head">
                              ...
                              <div class="tp-accordion-title pl-30">
                                 <h4 class="tp-toolest-title-info">Track<br> your rankings</h4>
                              </div>
                           </div>
                           <div class="tp-accordion-content">
                              <p>
      ...
      <section id="project-one-page" class="project-area pt-110">
         <div class="project-5 pb-120 p-relative fix">
            <div class="seo-shape-bg d-none d-md-block">
               <img src="assets/img/shape/seo-5-shape-bg-1.png" alt="">
            </div>
            <div class="container">
               <div class="row justify-content-center">
                  <div class="col-lg-8">
                     <div class="tpsection-wrapper mb-20">
                        <h2 class="tpsection-title-two mb-65">Our Handpicked <br>
                  ...
                  <div class="col-lg-4">
                     <div class="tp-panel-top mb-30">
                        ...
                        <div class="tp-panel-btn">
                           <a class="light-blue-btn" href="portfolio-2.html">View all Projects</a>
                        </div>
                     </div>
                  </div>
               </div>
               <div class="row-custom">
                  <div class="col-custom">
                     <div class="tp-panel-item p-relative">
                        <div class="tp-panel-thumb">
                           <img src="assets/img/banner/project-2-thumb-2.jpg" alt="">
                        </div>
                        <div class="tp-panel-content">
                           <div class="tp-panel-icon mb-30">
                  ...
                  <div class="col-custom">
                     <div class="tp-panel-item p-relative">
                        <div class="tp-panel-thumb">
                           <img src="assets/img/banner/project-2-thumb-3.jpg" alt="">
                        </div>
                        <div class="tp-panel-content">
                           <div class="tp-panel-icon mb-30">
                              <span><img src="assets/img/icon/panel-icon-3.png" alt=""></span>
                  ...
                  <div class="col-custom active">
                     <div class="tp-panel-item p-relative">
                        <div class="tp-panel-thumb">
                           <img src="assets/img/banner/project-2-thumb-1.jpg" alt="">
                        </div>
                        <div class="tp-panel-content">
                           <div class="tp-panel-icon mb-30">
                              <span><img src="assets/img/icon/panel-icon-3.png" alt=""></span>
                  ...
                  <div class="col-custom">
                     <div class="tp-panel-item p-relative">
                        <div class="tp-panel-thumb">
                           <img src="assets/img/banner/project-2-thumb-4.jpg" alt="">
                        </div>
                        <div class="tp-panel-content">
                           <div class="tp-panel-icon mb-30">
                              <span><img src="assets/img/icon/panel-icon-3.png" alt=""></span>
      ...
      <!-- team-area-start -->
      <section id="team-one-page" class="team-area pt-105 pb-140">
         <div class="container">
            <div class="row">
               <div class="col-lg-12">
               ...
               <div class="row align-items-center">
                  <div class="col-lg-6 col-md-8">
                     <div class="footer-widget-copyright">
                        <span>Copyright © 2023 <a target="_blank" href="https://themeforest.net/user/theme_pure/portfolio">Theme_Pure.</a> All Rights Reserved.</span>
                     </div>
                  </div>
