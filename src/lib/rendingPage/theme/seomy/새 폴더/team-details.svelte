...
<html class="no-js" lang="zxx">
   ...
   <main>
      ...
      <!-- team-area-start -->
      <section class="team-area team-details-bg pt-200 pb-100" data-background="assets/img/bg/team-details-bg.png">
         <div class="container">
                  ...
                  <div class="team-details p-relative">
                     <div class="team-details-info d-flex align-items-center mb-50">
                        <div class="team-details-thumb">
                           <img src="assets/img/team/details/team-details-1.png" alt="">
                        </div>
                        <div class="team-details-content">
                           <span class="team-details-position">Founder & CEO</span>
                           <h4 class="team-details-title">Danny Russell</h4>
                           <a class="team-details-email" href="mailto:danny@gmail.com"><span>Email:</span> danny@gmail.com</a>
                           <a class="team-details-number" href="tel:0123456789"><span>Phone:</span> +(476) 964 223 55</a>
                     ...
                     <div class="team-details-about mb-45">
                        <h3 class="team-details-about-title">About Me</h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do eiusmod tempor incididunt ut labore duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit.</p>
                     </div>
                     <div class="team-details-exprience">
                        <h3 class="team-details-exprience-title">Background & Experience</h3>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do eiusmod tempor
                           incididunt ut labore duis aute irure dolor.</p>
                        <ul>
                           <li>Brand Identity Solutions.</li>
                           <li>Retium nibh ipsum consequat nisl vel pretium.</li>
                           <li>Nam libero justo laoreet sit amet.</li>
                           <li>Visual Identity Improved.</li>
                        </ul>   
                     </div>
                     <div class="team-details-shape">
                        <img class="team-details-shape-1" src="assets/img/shape/about-inner-shape-2.png" alt="">
                        <img class="team-details-shape-2" src="assets/img/team/details/team-details-shape-1.png" alt="">
                        <img class="team-details-shape-3" src="assets/img/team/details/team-details-shape-2.png" alt="">
                     </div>
                  </div>
               </div>
            </div>
