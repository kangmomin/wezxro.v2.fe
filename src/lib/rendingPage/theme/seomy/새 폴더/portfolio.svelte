            ...
            <div class="row grid">
               <div class="col-lg-6 col-md-6 grid-item port3 port4">
                  <div class="portfolio-inner-item mb-60">
                     ...
                     <div class="portfolio-inner-content">
                        <span>Marketing</span>
                        <h4 class="portfolio-inner-title"><a href="/">Online Media Management</a></h4>
                     </div>
                  </div>
               </div>
               <div class="col-lg-6 col-md-6 grid-item port2 port3">
                  <div class="portfolio-inner-item mb-60">
                     ...
                     <div class="portfolio-inner-content">
                        <span>DESIGN</span>
                        <h4 class="portfolio-inner-title"><a href="/">Tips for the good UI design</a></h4>
                     </div>
                  </div>
               </div>
               <div class="col-lg-6 col-md-6 grid-item port4">
                  <div class="portfolio-inner-item mb-60">
                     ...
                     <div class="portfolio-inner-content">
                        <span>Marketing</span>
                        <h4 class="portfolio-inner-title"><a href="/">Sony Airpads Max</a></h4>
                     </div>
                  </div>
               </div>
               <div class="col-lg-6 col-md-6 grid-item port2 port3">
                  <div class="portfolio-inner-item mb-60">
                     ...
                     <div class="portfolio-inner-content">
                        <span>DESIGN</span>
                        <h4 class="portfolio-inner-title"><a href="/">A1_Driven Security Solutions</a></h4>
                     </div>
                  </div>
               </div>
               <div class="col-lg-6 col-md-6 grid-item port2 port3">
               ...
               <div class="col-lg-6 col-md-6 grid-item port2 port4">
                  <div class="portfolio-inner-item mb-60">
                     ...
                     <div class="portfolio-inner-content">
                        <span>Branding</span>
                        <h4 class="portfolio-inner-title"><a href="/">Twice Profit Than Before</a></h4>
                     </div>
                  </div>
               </div>
            </div>
                  ...
                  <div class="col-lg-3 col-md-6 col-sm-6">
                     <div class="footer-widget footer-5-col-1 mb-40">
                        <div class="footer-widget-logo mb-20">
                           <a href="/"><img src="assets/img/logo/SEOMY-2.png" alt=""></a>
                        </div>
