...
<body>
                  ...
                  <div class="row align-items-center">
                        ...
                        <div class="tpmenu__area main-mega-menu">
                           <nav class="tp-main-menu-content">
                              <ul class="tp-onepage-menu">
                                 ...
                                 <li><a href="#pricing-one-page">Pricing</a></li>
                     ...
                     <div class="col-xl-2 col-lg-6 col-sm-7 col-6">
                        <div class="header-btn header-btn-4 text-end">
                           <a class="blue-btn d-none d-xl-block" href="/contact">Contact Us</a>
   ...
   <main>
      ...
      <!-- banner-area-start -->
      <div class="banner-area banner-4-spaces pt-150">
         <div class="container">
            <div class="row">
                  ...
                  <div class="banner-4">
                     <div class="banner-4-content">
                        ...
                        <div class="banner-4-btn mb-30">
                           <a href="/contact" class="blue-btn">Get Started Now</a>
                        </div>
                           ...
                           <div class="contact-4-icon">
                              <i>
                                 <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path opacity="0.4" d="M20.7996 9.40038C20.7996 8.68038 20.2356 7.57638 19.3956 6.67638C18.6276 5.84838 17.6076 5.20038 16.5996 5.20038" stroke="#775AFC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path opacity="0.4" d="M24.9996 9.4C24.9996 4.756 21.2436 1 16.5996 1" stroke="#775AFC" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                 </svg>
                              </i>
                           </div>
            ...
            <div class="banner-4-shape d-none d-lg-block">
               <div class="banner-4-shape-one">
                  <img  src="assets/img/banner/hero-bg-4.png" alt="">
               </div>
               <div class="banner-4-shape-two">
                  <img src="assets/img/shape/banner-4-shape-1.png" alt="">
               </div>
               <div class="banner-4-shape-three">
                  <img src="assets/img/shape/banner-4-shape-2.png" alt="">
               </div>
               <div class="banner-4-shape-six">
                  <img src="assets/img/shape/banner-shape-4-1.png" alt="">
               </div>
               <div class="banner-4-shape-seven">
                  <img src="assets/img/shape/banner-shape-4-2.png" alt="">
               </div>
               <div class="banner-4-shape-eight">
                  <img src="assets/img/shape/banner-shape-4-3.png" alt="">
               </div>
               <div class="banner-4-shape-nine">
                  <img src="assets/img/shape/banner-shape-4-4.png" alt="">
               </div>
               <div class="banner-4-shape-ten">
                  <img src="assets/img/shape/banner-shape-4-5.png" alt="">
               </div>
            </div>
         </div>
      </div>
      ...
      <!-- services-area-start -->
      <section id="services-one-page" class="services-area pb-120 pt-195">
         <div class="container">
            <div class="row">
               <div class="col-lg-12">
      ...
      <!-- brand-area-start -->
      <section class="brand-area brand-bg-3 mb-60 p-relative">
      ...
      <!-- about-area-start -->
      <section id="about-one-page" class="feature-area pt-100 pb-80">
         <div class="container">
            <div class="row">
               <div class="col-lg-6">
                           ...
                           <div class="feature-list-4-item p-relative pl-100 d-flex">
                              <div class="feature-list-4-icon ">
                                 <div class="feature-list-bg p-relative">
                                    <i>
                                       <svg width="44" height="40" viewBox="0 0 44 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                          <g style="mix-blend-mode:multiply">
                                          <path class="main-bg main-bg-2" d="M4.66766 18.8519C-4.37425 32.8161 8.5593 40 19.4834 40C30.2244 40 42.3709 35.9136 42.3709 23.3559C42.3655 -8.96311 20.1854 -5.10428 4.66766 18.8519Z" fill="currentColor"/>
                                          </g>
                                          <path d="M0.886829 32.563C0.845942 32.563 0.805948 32.5509 0.771881 32.5281C0.737814 32.5053 0.711194 32.4729 0.695366 32.4349C0.679538 32.3968 0.675208 32.355 0.682925 32.3145C0.690641 32.274 0.710058 32.2367 0.738733 32.2073L8.96478 23.9395C9.00472 23.9178 9.05069 23.9101 9.09546 23.9176C9.14022 23.9251 9.18125 23.9474 9.21208 23.981C9.24291 24.0145 9.2618 24.0575 9.26578 24.1031C9.26975 24.1487 9.25859 24.1943 9.23404 24.2328L1.03493 32.5033C1.01546 32.5227 0.992326 32.538 0.966886 32.5483C0.941447 32.5585 0.914223 32.5635 0.886829 32.563V32.563Z" fill="white"/>
                                          <path d="M33.901 20.2052C33.8744 20.2053 33.8481 20.2001 33.8236 20.1899C33.7991 20.1796 33.7769 20.1645 33.7583 20.1455C33.7201 20.1064 33.6987 20.0537 33.6987 19.9989C33.6987 19.944 33.7201 19.8914 33.7583 19.8522C34.1056 19.4911 42.2751 11.0306 42.9887 10.55C43.0343 10.5237 43.0882 10.5159 43.1393 10.5281C43.1905 10.5403 43.2351 10.5717 43.2642 10.6159C43.2933 10.66 43.3047 10.7137 43.296 10.766C43.2873 10.8183 43.2593 10.8653 43.2175 10.8975C42.6548 11.2749 36.4132 17.6991 34.0625 20.1428C34.0415 20.1642 34.0163 20.1808 33.9884 20.1916C33.9606 20.2023 33.9308 20.207 33.901 20.2052V20.2052Z" fill="white"/>
                                       </svg>
                              ...
                              <div class="feature-4-shape-2 d-none d-md-block">
                                 <svg class="line-dash-path" width="42" height="122" viewBox="0 0 42 122" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M41.3076 1.22192C-1.33493 18.0137 -18.0874 85.181 32.5507 121.222" stroke="#A7ACB3" stroke-dasharray="4 4"/>
                                 </svg>
                              </div>
                           </div>
                        </li>
                              ...
                              <div class="feature-list-4-icon ">
                                 <div class="feature-list-bg p-relative">
                                    <i>
                                       <svg width="44" height="40" viewBox="0 0 44 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                          <g style="mix-blend-mode:multiply">
                                          <path class="main-bg main-bg-3" d="M4.66766 18.8519C-4.37425 32.8161 8.5593 40 19.4834 40C30.2244 40 42.3709 35.9136 42.3709 23.3559C42.3655 -8.96311 20.1854 -5.10428 4.66766 18.8519Z" fill="currentColor"/>
                                          </g>
                                          <path d="M0.886829 32.563C0.845942 32.563 0.805948 32.5509 0.771881 32.5281C0.737814 32.5053 0.711194 32.4729 0.695366 32.4349C0.679538 32.3968 0.675208 32.355 0.682925 32.3145C0.690641 32.274 0.710058 32.2367 0.738733 32.2073L8.96478 23.9395C9.00472 23.9178 9.05069 23.9101 9.09546 23.9176C9.14022 23.9251 9.18125 23.9474 9.21208 23.981C9.24291 24.0145 9.2618 24.0575 9.26578 24.1031C9.26975 24.1487 9.25859 24.1943 9.23404 24.2328L1.03493 32.5033C1.01546 32.5227 0.992326 32.538 0.966886 32.5483C0.941447 32.5585 0.914223 32.5635 0.886829 32.563V32.563Z" fill="white"/>
                                          <path d="M33.901 20.2052C33.8744 20.2053 33.8481 20.2001 33.8236 20.1899C33.7991 20.1796 33.7769 20.1645 33.7583 20.1455C33.7201 20.1064 33.6987 20.0537 33.6987 19.9989C33.6987 19.944 33.7201 19.8914 33.7583 19.8522C34.1056 19.4911 42.2751 11.0306 42.9887 10.55C43.0343 10.5237 43.0882 10.5159 43.1393 10.5281C43.1905 10.5403 43.2351 10.5717 43.2642 10.6159C43.2933 10.66 43.3047 10.7137 43.296 10.766C43.2873 10.8183 43.2593 10.8653 43.2175 10.8975C42.6548 11.2749 36.4132 17.6991 34.0625 20.1428C34.0415 20.1642 34.0163 20.1808 33.9884 20.1916C33.9606 20.2023 33.9308 20.207 33.901 20.2052V20.2052Z" fill="white"/>
                                       </svg>
                     ...
                     <div class="tpdrive-progress mb-25 pr-150">
                        <div class="tpdrive-bar-item mb-30">
                           ...
                           <div class="tpdrive-bar-progress">
                              <div class="progress">
                                 <div class="progress-bar wow slideInLeft" data-wow-delay="0s" data-wow-duration=".8s" role="progressbar" data-width="98%" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100" style="width: 98%; visibility: visible; animation-duration: 0.8s; animation-delay: 0s; animation-name: slideInLeft;">
                                    <span>98</span>
                                 </div>
                               </div>
                           </div>
                        ...
                        <div class="tpdrive-bar-item yellow-bar">
                           ...
                           <div class="tpdrive-bar-progress">
                              <div class="progress">
                                 <div class="progress-bar wow slideInLeft" data-wow-delay="0s" data-wow-duration=".8s" role="progressbar" data-width="84%" aria-valuenow="84" aria-valuemin="0" aria-valuemax="100" style="width: 65%; visibility: visible; animation-duration: 0.8s; animation-delay: 0s; animation-name: slideInLeft;">
                                    <span>84</span>
                                 </div>
                               </div>
                           </div>
               ...
               <div class="col-lg-6">
                  <div class="optimize-thumb text-end p-relative pt-35">
                     <div class="optimize-thumb-img">
                        <img src="assets/img/bg/optimize-bg.png" alt="">
                     </div>
                     <div class="optimize-shape">
                        <img src="assets/img/bg/optimize-bg-2.png" alt="" class="optimize-shape-1">
                        <img src="assets/img/shape/optimize-shape-2.png" alt="" class="optimize-shape-2 d-none d-md-block" data-parallax='{"y": 50, "smoothness": 20}'>
                        <img src="assets/img/shape/optimize-shape-1.png" alt="" class="optimize-shape-3 d-none d-md-block" data-parallax='{"y": 50, "smoothness": 20}'>
                     </div>
                  </div>
               </div>
            </div>
                     ...
                     <div class="counter-item-4-icon">
                        <i>
                           <svg width="18" height="28" viewBox="0 0 18 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M12.1967 8.97496L11.1834 8.82992V3.78816H12.2602V7.60474L15.4619 4.19164V0.614587H2.53824V4.19164L5.73933 7.60474V3.78816H6.81615V8.82992L5.80313 8.97496L1.46143 4.34574V0H16.5387V4.34574L12.1967 8.97496Z" fill="white"/>
                              <path d="M9 27.708C4.03724 27.708 0 23.7472 0 18.8786C0 14.0101 4.03724 10.0493 9 10.0493C13.9628 10.0493 18 14.0101 18 18.8786C18 23.7472 13.9628 27.708 9 27.708ZM9 11.1259C4.6311 11.1259 1.07681 14.6037 1.07681 18.8786C1.07681 23.1533 4.6311 26.6312 9 26.6312C13.3689 26.6312 16.9232 23.1533 16.9232 18.8786C16.9232 14.6037 13.3689 11.1259 9 11.1259Z" fill="white"/>
                              <path d="M5.27975 24.3296L6.70115 20.0441L2.96191 17.3825H7.58359L9.00014 13.1113L10.4164 17.3825H15.0384L11.2991 20.0441L12.7195 24.3296L9.00014 21.6803L5.27975 24.3296ZM9.00014 20.3585L10.6609 21.5414L10.0269 19.6285L11.6688 18.4596H9.63896L9.00014 16.5329L8.36132 18.4596H6.3318L7.97394 19.6285L7.33943 21.5414L9.00014 20.3585Z" fill="white"/>
      ...
      <section class="portfolio-area portfolio-4-bg pb-140 mb-35 fix p-relative">
                                 ...
                                 <div class="portfolio-4-item p-relative">
                                    ...
                                    <div class="portfolio-4-content">
                                       ...
                                       <div class="portfolio-4-content-bottom">
                                          <a href="portfolio-details.html">View Case Study <i class="fa-light fa-plus"></i></a>
                                       </div> 
                                    </div>
                                 </div>
                              </div>
      ...
      <!-- pricing-area-start -->
      <section id="pricing-one-page" class="pricing-area tp-price-parent tppricing-box-active pb-170 fix pt-85">
         <div class="container">
            <div class="row">
               <div class="col-lg-12">
      ...
      <!-- contact-area-start -->
      <section id="contact-one-page" class="contact-area p-relative contact-bg-4 pb-65 pt-105">
         ...
         <div class="contact-shape d-none d-lg-block">
            <img src="assets/img/shape/contact-4-shape-1.png" alt="" class="contact-shape-1">
            <img src="assets/img/shape/contact-4-shape-2.png" alt="" class="contact-shape-2">
            <img src="assets/img/shape/contact-4-shape-3.png" alt="" class="contact-shape-3">
            <img src="assets/img/shape/contact-4-shape-4.png" alt="" class="contact-shape-4">
            <img src="assets/img/shape/contact-4-shape-5.png" alt="" class="contact-shape-5 d-none d-xxl-block">
            <img src="assets/img/shape/contact-4-shape-6.png" alt="" class="contact-shape-6 d-none d-xxl-block">
         </div>
         <div class="container">
            <div class="row">
               <div class="col-lg-6">
      ...
      <!-- blog-area-start -->
      <section id="blog-one-page" class="blog-area pb-50 p-relative fix pt-90">
         <div class="tpblog-4-shape wow bounceIn d-none d-lg-block" data-wow-duration=".6s" data-wow-delay=".6s">
            <img src="assets/img/shape/blog-4-shape-1.png" alt="">
         </div>
         <div class="container">
            <div class="row align-items-center">
               <div class="col-lg-8 ">
               ...
               <div class="col-lg-4">
                  <div class="blog-all-btn text-lg-end mb-40">
                     <a href="blog-list.html" class="blue-btn">More Articles</a>
                  </div>
               </div>
            </div>
            <div class="row">
                     ...
                     <div class="row justify-content-end">
                        <div class="col-lg-7 col-md-7">
                           <div class="tpblog-4-content">
                              ...
                              <h4 class="tpblog-4-content-title"><a href="blog-details.html">Wins 2023 good design london Award</a></h4>
                  ...
                  <div class="tpblog-4 mb-60">
                     ...
                     <div class="row justify-content-end">
                        <div class="col-md-7 ">
                           <div class="tpblog-4-content">
                              <h5 class="tpblog-4-content-sub-tilte">SEO agency</h5>
                              <h4 class="tpblog-4-content-title"><a href="blog-details.html">Me in resolution pianoforte continuing</a></h4>
                              <p>The annual good design Awards <br> is london oldest prestigious.</p>  
                              <div class="tpblog-4-info">
                                 <span>Nev 21,2023</span>
                                 <span><a href="#"><i>By</i> Admin</a></span>
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                        <div class="footer-widget-copyright footer-widget-copyright-4 text-center">
                           <span>© 2023 <a target="_blank" href="https://themeforest.net/user/theme_pure/portfolio">Theme_Pure.</a> All Rights Reserved.</span>
                        </div>
                     </div>
                  </div>
               </div>
