...
<body>
   ...
   <main>
      ...
      <!-- services-area-start -->
      <section class="services-area theme-bg-4 pb-120 fix">
      ...
      <!-- rating-area-start -->
      <section class="rating-area theme-bg-4">
         <div class="container">
            <div class="row justify-content-center">
               <div class="col-lg-6">
      ...
      <!-- review-area-start -->
      <section class="review-area p-relative theme-bg-4 pt-90 pb-120">
         <div class="container">
      ...
      <!-- blog-area-start -->
      <section class="blog-area theme-bg-4 pb-100">
         <div class="container">
            <div class="row justify-content-center">
               <div class="col-lg-8">
                  <div class="tpsection-wrapper text-center">
