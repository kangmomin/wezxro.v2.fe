                     ...
                     <div class="tp-postbox-wrapper">
                        <article class="tp-postbox-item format-image mb-50 transition-3">
                           ...
                           <div class="tp-postbox-content">
                              <div class="tp-postbox-meta">
                                 <span><i class="far fa-calendar-check"></i> July 21, 2023 </span>
                                 <span><a href="#"><i class="far fa-user"></i> MR Tanvir</a></span>
                                 <span><a href="#"><i class="fal fa-comments"></i> 02 Comments</a></span>
                              </div>
                              <h3 class="tp-postbox-title">
                                 <a href="/">Perfect From Beginning to End Faster and More Efficiently</a>
                              </h3>
                        ...
                        <article class="tp-postbox-item format-video mb-50 transition-3">
                           <div class="tp-postbox-thumb tp-postbox-video w-img p-relative">
                              ...
                              <a href="https://youtu.be/-WRZI63emjs" class="tp-postbox-video-btn popup-video tpvideo-icon-anim"><i class="fas fa-play"></i></a>
                           </div>
                           <div class="tp-postbox-content">
                              <div class="tp-postbox-meta">
                                 <span><i class="far fa-calendar-check"></i> July 21, 2023 </span>
                              ...
                              <h3 class="tp-postbox-title">
                                 <a href="/">Six Ways to Improve Conversions and Makes Employes Happy</a>
                              </h3>
                              <div class="tp-postbox-text">
                                 <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat […]</p>
                              </div>
                        ...
                        <article class="tp-postbox-item format-audio mb-50 transition-3">
                           ...
                           <div class="tp-postbox-content">
                              ...
                              <h3 class="tp-postbox-title">
                                 <a href="/">Complete Link Building Guide for Beginners From the Professionals</a>
                              </h3>
                              <div class="tp-postbox-text">
                                 <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat […]</p>
                              </div>
                        ...
                        <article class="tp-postbox-item format-image mb-50 transition-3">
                           ...
                           <div class="tp-postbox-content">
                              ...
                              <h3 class="tp-postbox-title">
                                 <a href="/">Getting Ready to Chase Google Sitelinks</a>
                              </h3>
                              <div class="tp-postbox-text">
                                 <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat […]</p>
                              </div>
