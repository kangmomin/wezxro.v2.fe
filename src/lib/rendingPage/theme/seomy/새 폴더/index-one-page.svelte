...
<body>
                              ...
                              <button class="button-search-toggle">
                                 ...
                                 <i class="header_search-button">
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                       <path d="M9.55 18.1C14.272 18.1 18.1 14.272 18.1 9.55C18.1 4.82797 14.272 1 9.55 1C4.82797 1 1 4.82797 1 9.55C1 14.272 4.82797 18.1 9.55 18.1Z" stroke="#271D3A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                       <path d="M19.0001 19L17.2001 17.2" stroke="#271D3A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                                 </i>
                           ...
                           <button type="submit" class="search-submit-icon">
                              <i>
                                 <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M19.0001 19L17.2001 17.2" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                 </svg>
                              </i>
                           </button>
                      </form>
   ...
   <main>
         ...
         <div class="tpbanner-shape-wrappers">
            ...
            <div class="tpbanner-shape  d-none d-lg-block">
               ...
               <div class="tpbanner-shape-five">
                  <img class="layer" data-depth="0.2" src="assets/img/shape/banner-pose.png" alt="">
               </div>
               <div class="tpbanner-shape-six">
                  <img class="layer" data-depth="0.3" src="assets/img/shape/banner-tree.png" alt="">
               </div>
            </div>
         </div>
         <div class="tpbanner-shape-wrappers tpbanner-shape-y scene-y">
            <div class="tpbanner-shape  d-none d-lg-block">
               <div class="tpbanner-shape-two" >
                  <img class="layer" data-depth="0.6" src="assets/img/shape/banner-megaphone.png" alt="">
               </div>
            </div>
         </div>
      </section>
      ...
      <!-- process-area-start -->
      <section id="about-one-page" class="process__area pt-120 pb-120">
         <div class="container">
            <div class="row">
               <div class="col-lg-12">
                           ...
                           <div class="row">
                                 ...
                                 <div class="tpanalysis__catagory ml-20 mb-40">
                                    <div class="tpanalysis__item">
                                       <h3 class="tpanalysis__count mb-10">
                                          <span data-purecounter-duration="1" data-purecounter-end="10265"  class="purecounter">10,265</span></h3>
                              ...
                              <div class="col-lg-4 col-md-4">
                                 <div class="tpanalysis__catagory text-center mb-40">
                                    <div class="tpanalysis__item">
                                       <h3 class="tpanalysis__count mb-10">
                                          <span data-purecounter-duration="1" data-purecounter-end="8426"  class="purecounter">8,426</span></h3>
                              ...
                              <div class="col-lg-4 col-md-4">
                                 <div class="tpanalysis__catagory d-flex justify-content-end mr-25 mb-40">
                                    <div class="tpanalysis__item">
                                       <h3 class="tpanalysis__count mb-10">
                                          <span data-purecounter-duration="1" data-purecounter-end="726"  class="purecounter">726</span>%</h3>
                           ...
                           <div class="row">
                              <div class="col-lg-4 col-md-4">
                                 <div class="tpanalysis__catagory ml-20 mb-40">
                                    <div class="tpanalysis__item">
                                       <h3 class="tpanalysis__count mb-10">
                                          <span data-purecounter-duration="1" data-purecounter-end="726"  class="purecounter">10,265</span></h3>
                                       <p>Annual Organic Traffic</p>
                                    </div>
                                 </div>
                              </div>
                              <div class="col-lg-4 col-md-4">
                                 <div class="tpanalysis__catagory text-center mb-40">
                                    <div class="tpanalysis__item">
                                       <h3 class="tpanalysis__count mb-10">
                                          <span data-purecounter-duration="1" data-purecounter-end="1026"  class="purecounter">8,426</span></h3>
                                       <p>Ranking Keywords</p>
                                    </div>
                                 </div>
                              </div>
                              <div class="col-lg-4 col-md-4">
                                 <div class="tpanalysis__catagory d-flex justify-content-end mr-25 mb-40">
                                    <div class="tpanalysis__item">
                                       <h3 class="tpanalysis__count mb-10"> 
                                          <span data-purecounter-duration="1" data-purecounter-end="488"  class="purecounter">726</span>%</h3>
                                       <p>Return on Investment</p>
                                    </div>
                                 </div>
                              </div>
      ...
      <!-- services-area-start -->
      <section id="services-one-page" class="services-area pt-140 pb-110">
         <div class="container">
            <div class="row">
               <div class="col-lg-12">
                  <div class="tpsection__content text-center mb-70">
                  ...
                  <div class="tpchoose-wrapper mb-30">
                     ...
                     <div class="row gx-6">
                        <div class="col-lg-4 col-md-4 col-sm-6">
                           <a href="/about" class="tpchoose mb-30">
      ...
      <!-- pricing-area-start -->
      <section id="pricing-one-page" class="pricing-area tp-price-parent pricing-shape-relative p-relative pt-120 pb-90">
      ...
      <section class="textimonial-area fix">
         <div class="container">
            <div class="row">
               <div class="col-lg-12">
      ...
      <!-- blog-area-start -->
      <section id="blog-one-page" class="blog-area pb-75 pt-120">
         <div class="container">
               ...
               <div class="col-lg-6 col-md-4">
                  <div class="tpblog-all mb-60">
                     <a href="/">See all our Blog
                        <i>
                           <svg width="23" height="12" viewBox="0 0 23 12" fill="none" xmlns="http://www.w3.org/2000/svg">  <path d="M16.7095 1L21.7095 6L16.7095 11" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/> <path d="M1 6H21" stroke="white" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                           </svg>
                        </i>
                     </a>
                  </div>
            ...
            <div class="row">
               <div class="col-lg-4 col-md-6 col-sm-6">
                  <div class="tpblog mb-30">
                     <div class="tpblog-thumb mb-25 fix">
                        <a href="/"><img src="assets/img/blog/blog-1-bg-1.jpg" alt=""></a>
                     </div>
                     <div class="tpblog-content">
                        ...
                        <h3 class="tpblog-title"><a href="/">Simple ways to Optimize your Website For SEO</a></h3>
               ...
               <div class="col-lg-4 col-md-6 col-sm-6">
                  <div class="tpblog mb-30">
                     <div class="tpblog-thumb mb-25 fix">
                        <a href="/"><img src="assets/img/blog/blog-1-bg-2.jpg" alt=""></a>
                     </div>
                     <div class="tpblog-content">
                        <div class="tpblog-tag">
                           <a href="/">SEO Analysis</a>
                        ...
                        <h3 class="tpblog-title"><a href="/">The Trend of Marketing With <br> Tiktok, Should or not?</a></h3>
                        <div class="tpblog-avatar d-flex align-items-center">
                           <div class="tpblog-avatar-thub mr-10">
               ...
               <div class="col-lg-4 col-md-6 col-sm-6">
                  <div class="tpblog mb-30">
                     <div class="tpblog-thumb mb-25 fix">
                        <a href="/"><img src="assets/img/blog/blog-1-bg-3.jpg" alt=""></a>
                     </div>
                     <div class="tpblog-content">
                        <div class="tpblog-tag">
                           <a href="/">SEO Analysis</a>
                        ...
                        <h3 class="tpblog-title"><a href="/">How to Increase Your ROI Through scientific SEM?</a></h3>
                        <div class="tpblog-avatar d-flex align-items-center">
                           <div class="tpblog-avatar-thub mr-10">
      ...
      <!-- contact-area-start -->
      <section id="contact-one-page" class="contact-area theme-bg-3 pt-120 pb-120">
         <div class="container">
            <div class="row">
               <div class="col-lg-5">
                     ...
                     <div class="col-lg-3 col-md-6">
                        <div class="footer-widget footer-col-1 mb-40">
                           ...
                           <div class="footer-widget-content">
                              <p class="footer-widget-text mb-20">This SEO is most reputed <br> firm which provides
                                 various <br> online marketing </p>
