...
<main>
    ...
    <!-- about-area-start -->
    <section class="about-area p-relative pt-170 pb-180" data-background="{config.aboutInner.mainBg}">
        <div class="fix">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-lg-12">
                        <div class="about-inner-slide tpabout-inner-active">
                            {#each config.aboutInner.inner as i}
                    ...
                    <div class="col-xxl-8 col-lg-10 col-md-9">
                        <div class="tptestimonial-area-two p-relative">
                            <div class="tptestimonial-active-two">
                                {#each config.testimonial.reviews as r}
