                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-widget-copyright footer-widget-copyright-4 text-center">
                            <span>© 2023 <a href="https://themeforest.net/user/theme_pure/portfolio" target="_blank">Theme_Pure.</a> All Rights Reserved.</span>
                        </div>
                    </div>
                </div>
            </div>
